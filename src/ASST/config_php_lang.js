module.exports = {
	...
	PHP_EXE_BIN_PATH: "", // Currently set for Windows // leave it empty "" if not set (if you don't have PHP binary) 
	
	// is web app using DBMS?
	IS_DBMS_USED: false, // true or false // DBMS System must be installed, for an example: for MySQL, XAMPP works great.
